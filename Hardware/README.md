...
The majority of the electronics, incuding the Arduino Nano, are mounted on the '[main board](https://github.com/m0xpd/STRACHEY/blob/main/Hardware/Main/ReadMe.md)', whilst user-interface components are mounted on the '[control board](https://github.com/m0xpd/STRACHEY/blob/main/Hardware/Control/README.md)'.

<p width=100%, align="center">
<img width=20%, src="https://github.com/m0xpd/STRACHEY/blob/main/Hardware/Graphics/STRACHEY%20Side%20Assembled.jpg".  
</p>
...
The system was developed in [KiCad](https://www.kicad.org/) (the first electronic project I have undertaken using this software). KiCad projects for the boards are presented in the Main and Control folders, along with schematics, BoMs and limited circuit descriptions. A [Front Panel design](https://github.com/m0xpd/STRACHEY/blob/main/Hardware/Panel/README.md) is also available as a KiCad project.
